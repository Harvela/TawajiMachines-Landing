  ...
  return (
    <div id="categories" className="relative h-[50vh]">
      ...
      <div className="px-4 py-8 md:px-16">
        <div className="mt-12 grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-16">
          {machines.map((machine, index) => {
            return (
              <div
                key={index}
                className="flex h-[80vh] flex-col rounded-md bg-white text-black shadow-md"
              >
                <img
                  src={machine.image}
                ...
                <div className="flex flex-col gap-6 p-2 md:p-6">
                  ...
                  <Link href={`/machines/${machine.link}`}>
                    <button className="w-[60%] rounded-sm bg-primary-700 p-1 text-[11px] text-white md:w-[50%] md:text-sm">
                      Voir les details
                    </button>
                  </Link>
                </div>
