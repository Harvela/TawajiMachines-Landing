    ...
    <>
      <div className="relative h-[50vh]">
        ...
        <div className="absolute left-0 top-0 flex h-[50vh] w-full flex-col items-center justify-center bg-[#000000]/80">
          ...
          <div>
            <h1 className="text-center text-[48px] font-semibold text-white">
              COMPACTEURS
            </h1>
            <div className="m-auto flex flex-row items-center justify-center p-8 text-sm font-semibold text-white">
              <Link
                href="/#home"
                className="mr-2 flex flex-row items-center justify-between text-[20px]"
              >
                HOME
              ...
              <Link
                href="/#categories"
                className="flex flex-row items-center justify-between text-[20px] text-primary-700"
              >
                COMPACTEUS
              </Link>
            </div>
